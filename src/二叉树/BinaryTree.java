...
//        System.out.println(TreeCount(tree1));
    ...
    public static BinaryTree initTree(int data,BinaryTree<Integer> atree){
        BinaryTree<Integer> tree = new BinaryTree<>(data,null,null);
        if(atree.data==null){
            atree.data=data;
            ...
            if(atree.right==null){
                ...
                initTree(data,atree.right);
            }
        }else {
            if(atree.left==null){
                atree.left=tree;
            }else {
                initTree(data,atree.left);
            }
        }
return atree;
    }
